...
public class FirstTabPresenter extends BasePresenter<FirstTabView> {
    ...
    public void setPetsInAdapter() {
        ...
        Disposable disposable = requestsService.getPets(SavingConfigMvpApp.getContext().getResources().getString(R.string.request_pet_cat))
    ...
    public void setLastListPosition(int position) {
        PrefUtils.setFirstScrollPosition(position);
    }

    public int getLastListPosition() {
        return PrefUtils.getFirstScrollPosition();
    }
}
